...
import com.bolsadeideas.springboot.web.app.models.entity.ItemFactura;
...
public class FacturaController {
	...
	// Metodo que me permite crear una factura por cliente.
	...
	//Metodo que permite ver la factura por su id

	@GetMapping("/ver/{id}")
	public String ver(@PathVariable(value = "id") Long id, Model model, RedirectAttributes flash,SessionStatus status) {
	...
	// produces= {"application/json"}) produce una salida tipo json
